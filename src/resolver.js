export const m = (function app(window, undefined) {
    "use strict";
    var VERSION = "v0.2.1";
...
export const container = (component, queries = {}, instance=resolver()) => {
    let x = m.component({
        controller: function() {
            ...
            return {...component.controller.call(this), done, instance}
        },
        view: function({done, instance}, args) {
            if(!done()) return null;

            return m.component(component, {...args, instance, ...instance.getState()})
        }
    })
...
export const wrap = (
    view,
    controller=(...args)=>{ return {} },
    data={},
    instance
) =>
    container({view, controller}, data, instance)

resolver.render = (component, node) => {
    if(!component.__mithril_resolver_container)
